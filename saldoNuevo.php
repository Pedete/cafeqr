...
mysql_select_db($database_cafeqr, $cafeqr);
$query_cafeHoy = "SELECT sum(transacciones.transaccion) as cafeHoy FROM transacciones WHERE idCliente = X AND fecha BETWEEN Y AND Z";
$cafeHoy = mysql_query($query_cafeHoy, $cafeqr) or die(mysql_error());
$row_cafeHoy = mysql_fetch_assoc($cafeHoy);
$totalRows_cafeHoy = mysql_num_rows($cafeHoy);
